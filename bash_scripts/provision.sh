...
function init-variables {
    ...
    PROVISIONER_URL="http://10.127.127.147:2020/provisioner/v1"
    IDENTITY_URL="http://10.127.127.147:2021/identity/v1"
    RHYTHM_URL="http://10.127.127.147:2022/rhythm/v1"
    OFFICE_URL="http://10.127.127.147:2023/office/v1"
    CUSTOMER_URL="http://10.127.127.147:2024/customer/v1"
    ACCOUNTING_URL="http://10.127.127.147:2025/accounting/v1"
    PORTFOLIO_URL="http://10.127.127.147:2026/portfolio/v1"
    DEPOSIT_URL="http://10.127.127.147:2027/deposit/v1"
    TELLER_URL="http://10.127.127.147:2028/teller/v1"
    REPORT_URL="http://10.127.127.147:2029/report/v1"
    CHEQUES_URL="http://10.127.127.147:2030/cheques/v1"
    PAYROLL_URL="http://10.127.127.147:2031/payroll/v1"
    GROUP_URL="http://10.127.127.147:2032/group/v1"
    NOTIFICATIONS_URL="http://10.127.127.147:2033/notification/v1"
